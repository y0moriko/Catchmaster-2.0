      ...
      <nav className="fixed top-0 w-full bg-white/95 backdrop-blur-sm border-b border-border z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <Link
              href="/signup"
              className="bg-primary text-white px-4 sm:px-5 py-2 rounded-lg text-sm font-semibold hover:bg-slate-700 transition-all shadow-md"
            >
              Get Started
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <Link
                  href="/signup"
                  className="bg-primary text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-bold hover:bg-slate-700 transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2 group text-sm sm:text-base"
                >
              ...
              <div className="flex items-center gap-4 sm:gap-6 pt-4">
                <div className="flex -space-x-2">
                  {[1,2,3,4].map((i) => (
                    <div key={i} className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-slate-200 border-2 border-white flex items-center justify-center">
            ...
            <div className="relative order-first lg:order-last">
              <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-primary rounded-2xl sm:rounded-3xl blur-3xl opacity-20 -z-10" />
              <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl border border-border p-6 sm:p-8 relative">
                    ...
                    {[
                      ...
                      <div key={item.species}>
                        ...
                        <div className="h-2 bg-slate-100 rounded-full overflow-hidden">
                          <div className={`h-full bg-blue-600 rounded-full ${item.bar}`} />
                        </div>
                      </div>
                    ))}
                  </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              <div key={feature.title} className="bg-white p-6 rounded-2xl border border-border hover:shadow-lg transition-all group">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              <div key={item.step} className="relative">
                <div className="bg-white p-6 sm:p-8 rounded-2xl border border-border relative z-10">
                ...
                {item.step !== "03" && (
                  <ArrowRight className="hidden md:block absolute top-1/2 -right-4 w-8 h-8 text-primary/30 z-20" />
                )}
              </div>
            ))}
          </div>
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 bg-gradient-to-r from-primary to-blue-800">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/signup"
              className="bg-white text-primary px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-bold hover:bg-slate-100 transition-all shadow-lg flex items-center justify-center gap-2 group text-sm sm:text-base"
            >
            ...
            <Link
              href="/demo"
              className="border-2 border-white text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-bold hover:bg-white/10 transition-all flex items-center justify-center gap-2 text-sm sm:text-base"
            >
